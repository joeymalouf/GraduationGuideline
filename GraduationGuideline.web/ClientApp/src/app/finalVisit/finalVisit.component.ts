...
@Component({
  selector: 'app-finalVisit',
  templateUrl: './finalVisit.component.html',
  styleUrls: ['./finalVisit.component.css']
})

@Injectable()
export class FinalVisitComponent {
  public step: Step;
  deadline: any;
  ...
  getStatus() {
    this.http.get<Step>('api/step/GetStep/Final Visit', {
  ...
  toggleStatus() {
    this.http.post<Step>('api/step/ToggleStepStatus/Final Visit', {}, {
      headers: new HttpHeaders({
        "Authorization": "Bearer " + this.token,
        "Content-Type": "application/json"
      })
