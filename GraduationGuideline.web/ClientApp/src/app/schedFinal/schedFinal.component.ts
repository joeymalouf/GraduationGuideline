...
@Component({
  selector: 'app-schedFinal',
  templateUrl: './schedFinal.component.html',
  styleUrls: ['./schedFinal.component.css']
})
...
export class ScheduleExamComponent {
  ...
  getStatus() {
    this.http.get<Step>('api/step/GetStep/Schedule Exam', {
  ...
  toggleStatus() {
    this.http.post<Step>('api/step/ToggleStepStatus/Schedule Exam', {}, {
      headers: new HttpHeaders({
        "Authorization": "Bearer " + this.token,
        "Content-Type": "application/json"
      })
